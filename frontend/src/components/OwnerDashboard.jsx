...
const navigate=useNavigate()
  ...
  return (
    <div className="w-full min-h-screen bg-[#fff9f6] fle flex-col items-center">
        {!myShopData &&
        <div className="flex justigy-center items-center p-4 sm:p-6">
           <div className="w-full max-m-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow duration-300<div>">
            <div className="flex flex-col items-center text-center">
               <FaUtensils className="text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4" />
               <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2">Add Your Restaurant</h2>
               <p className="text-gray-600 mb- text-sm sm:text-base">Join our food delivery platform and reach thousands of hiungry customers every day</p>
      ...
      <div className="w-full flex flex-col items-center gap-6 px-4 sm:px-6">
        ...
        <div className="bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative">
          ...
          <img src={myShopData.image} alt={myShopData.name} className="w-full h-50 sm:h-64 object-cover"/>
<div className="p-4 sm:p-6">
        ...
        <div className="flex justigy-center items-center p-4 sm:p-6">
           <div className="w-full max-m-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow duration-300<div>">
            <div className="flex flex-col items-center text-center">
               ...
               <p className="text-gray-600 mb- text-sm sm:text-base">Share your delicious creations with our customers by adding them to the menu</p>
  ...
  <div className="flex flex-col items-center gap-4 w-full max-w-3xl">
    {[...new Map(myShopData.items.map(i => [i._id, i])).values()]
      .map(item => (
