...
console.log(error)
    ...
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible">
      {showSearch && userData?.role=="user" && (
        <div className="w-[90%]  h-[70px] bg-white shadow-xl rounded-lg items-center gap-[20px] flex  fixed top-[80px] left-[5%]">
          <div className="flex-itms-center w-[30%] overflow-hidden gap-[10px] px-[10px] border-r-[2px] border-gray-400">
          ...
          <div className="w-[80%] flex items-center gap-[10px]">
            ...
            <input
              ...
              className="px-[10px] tet-gray-700 outline-0 w-full"
      ...
      {userData?.role=="user" &&
      <div className="md-w-[60%] lg:w-[40%]  h-[70px] bg-white shadow-xl rounded-lg items-center gap-[20px] flex  hidden md:flex">
      ...
      <div className="flex items-center gap-4">
        ...
        {userData?.role=="owner" ? <>
        {myShopData && <>
           <button className="hidden md:flex items-center p-2 cursor-pointer rounded-full bg-[#ff4d2d]/10 text-[#ff4d2d]" onClick={()=>navigate("/add-item")}>
               <FaPlus size={20} />
 ...
 <button className="md:hidden flex items-center gap-1 p-2 cursor-pointer rounded-full bg-[#ff4d2d]/10 text-[#ff4d2d]" onClick={()=>navigate("/add-item")}>
           ...
           <div className="hidden md:flex items-center gap-2 cursor-pointer relative px-3 py-1 rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d] font-medium" onClick={()=>navigate("my-orders")}>
                <TbReceipt2 />
                <span >My Orders</span>
                <span className="absolute -right-2 -top-2 text-xs fot-bold text-white bg-[#ff4d2d] rounded-full px-[6px] py-[1px]">0</span>
           </div>
